...
namespace SideHustleNZ
{
    ...
    /// </summary>
    public sealed partial class EmployeeHome : Page
    {
        public EmployeeHome()
        {
       ...
       /* private void GoToJobs_Tapped(object sender, TappedRoutedEventArgs e)
        {
            //Navigate to job listings
            this.Frame.Navigate(typeof(LookAtJobs));
        }

        private void GoToSettings_Tapped(object sender, TappedRoutedEventArgs e)
        {
            //Navigate to employee settings
            this.Frame.Navigate(typeof(EmployeeSettings));
        }*/

        private void GoToJobs_Tapped_1(object sender, TappedRoutedEventArgs e)
        {
            //Navigate to jobs
            this.Frame.Navigate(typeof(LookAtJobs));
        }
